                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" placeholder="Contact" name="enq_consultation"  id="myInput" onkeyup="myFunction()">
                                            </div>
...
<?php 
 ...
 $insertss= "Insert into enq_consultation(enq_consultation,status)values ('$enq_consultation','C')";
			 ...
			 if($seresins)
			  {
		          ...
		          echo "</script>";
				 	echo'<script>
  window.location= "enqconsult.php?msg=Inserted Successfully";
</script>';
			//	header("location:news.php?msg=Inserted Successfully");
			 ...
			 { 
			     	echo'<script>
  window.location= "enqconsult.php";
</script>';
	...
	?>
        ...
        <div class="table-responsive">
                                            <table class="table mb-0" id="myTable">
                                                ...
                                                <tbody><?php
                             $qry="SELECT * from enq_consultation";
                            ...
                            {?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['enq_consultation'];?></td>
