                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Enquiry Joint Venture</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" placeholder="Contact" name="enq_jointventure"  id="myInput" onkeyup="myFunction()">
                                            </div>
...
<?php 
 ...
 $insertss= "Insert into enq_jointventure(enq_jointventure,status)values ('$enq_jointventure','C')";
			 ...
			 if($seresins)
			  {
		          ...
		          echo "</script>";
				 	echo'<script>
  window.location= "enqjointventure.php?msg=Inserted Successfully";
</script>';
			//	header("location:news.php?msg=Inserted Successfully");
			 ...
			 { 
			     	echo'<script>
  window.location= "enqjointventure.php";
</script>';
	...
	?>
        ...
        <div class="table-responsive">
                                            <table class="table mb-0" id="myTable">
                                                ...
                                                <tbody><?php
                             $qry="SELECT * from enq_jointventure";
                            ...
                            {?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['enq_jointventure'];?></td>
